...
class CartController extends Controller
{
    ...
    public function getAddToCart(Request $request, $id) 
    {
        ...
        $cart->add($product, $product->id, $extra_cost_exist);
    ...
    public function getRemoveItem($id) 
    {
        ...
        $oldCart = Session::has('cart') ? Session::get('cart') : null;
        $cart = new Cart($oldCart);
        $cart->removeItem($id, $extra_cost_exist);
    ...
    public function getupdateItem(Request $request) 
    {
        ...
        $product = Product::find($id);
        $stock = $product->productStokc->stock;
        $extra_cost_exist = $product->extraCost != null ? $product->extraCost->cargo : 0;
        $oldCart = Session::has('cart') ? Session::get('cart') : null; 
        $cart = new Cart($oldCart);
        $cart->updateItem($product, $id, $qty, $extra_cost_exist, $stock);
